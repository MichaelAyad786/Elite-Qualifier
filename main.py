...
def AutoCorrect(word, database={'elephant', 'dragon', 'etc'}, sim_threshold = 0.5):
  max_sim = 0.0
  most_sim_word = word
...
if __name__ == "__main__":
  #print(create_bigram('drahgon'))


  #print(get_similarity_ratio('dragon', 'drahgon'))


  print(AutoCorrect('drahgon'))